# Pair programming pair 2 - Guada, Laura - Ficheros 2

# En la sesión anterior nos creamos un repositorio, con nuevas carpetas, incluso las cambiamos el nombre. Además practicamos como abrir un fichero que habíamos compartido con vosotras. En esta segunda sesión de pair-programming 
# trabajaremos en XXXXXXXXXX.
# Crear dos funciones que nos permitan:
# 1. Crear un nuevo fichero e introducirle contenido. TXT
# 2. Leer un archivo xml evaluar cuáles son sus atributos y sus valores. XML


# ------ FUNCIÓN LECTURA Y ESCRITURA DE FICHEROS -------
# La función debe recibir 4 parámetros: Nombre del fichero, incluyendo la extensión.
...
print(os.listdir("/mnt/c/Users/a/Desktop/Adalab/DA-promo-A-module-1-pairprog2-pair-2-GL/Python"))


with open('ficherito.txt', 'w') as f:                           #creamos archivo ficherito.txt
    f.write("Estamos introduciendo contenido")
    
with open('ficherito.txt') as r:
    print(r.read())
...
if pregunta == 'si':
    ...
    os.rename('ficherito.txt', pregunta2)
...
# ------ FUNCIÓN ARCHIVO XML -------
# Dentro de la carpeta teníais un archivo llamado peliculas.xml que contiene una lista de películas.
